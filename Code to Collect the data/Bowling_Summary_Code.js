//Now we collect the bowling summary data again same procedure as batting

//interactive code to fetch the links
...
//interactive code to fetch the bowling data from the individual links
navigate(input.url);
collect(parse());

//Parser code to fetch the bowling data from the individual links
