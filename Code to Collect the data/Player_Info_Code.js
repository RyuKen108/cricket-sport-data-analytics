//Now we fetch the data of each player in the tournament

//interactive code to fetch the individual links
...
//parser code to fetch the individual links
let links = []
...
//Now we get the individual links we will fetch the data from those links

//Interactive code to store all the players in a list
navigate(input.url);
...
//Parser code to store all the players in a list
var playersLinks = []
...
//Now fetch the data from the list

//interactive code to fetch the data
navigate(input.url);
final_data = parse()
collect(
{
