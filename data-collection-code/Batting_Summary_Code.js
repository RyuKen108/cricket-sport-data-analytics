//Interactive code to fetch the links from match summary
...
//parser code to fetch the links from match summary
let links = []
...
//Now we will fetch the data from the individual links we got from match summary webpage

//interactive code to fetch batting summary data
navigate(input.url);
collect(parse());

//parser code to fetch batting summary data
